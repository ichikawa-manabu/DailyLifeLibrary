...
public class Initialization {
    ...
    public static void main(String args[]) throws IOException {
        ...
        int page=2;
        int[] test_individual = new int[defaultGeneLength];
        int[] unit = new int[NO_OF_PARAMETERS];
        //test_individual = creat(unit,file,page);
        //for(int i=0;i<test_individual.length;i++){
        //System.out.println(i+" is "+test_individual[i] );
        //}
        //二つのファイル対応するページ番号が違います

        String Name=name(file,page);
