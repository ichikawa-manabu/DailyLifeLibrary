...
public class Evaluation {
   ...
   public static void sa_calculation(File infile1, int sheet_num1, File infile2, int sheet_num2, File out, File out2, File out3) throws Exception {
    ...
    Evaluation(File inDir, File outDir, int sheet_num1, int sheet_num2 ) throws Exception {
        ...
        File  outFile1 = new File(outDir.getPath() + "/"+Name+"学校行く時間.csv");
        File  outFile2 = new File(outDir.getPath() + "/"+Name+"学校から帰る時間.csv");
        File  outFile3 = new File(outDir.getPath() + "/"+Name+"学校から家に着く時間.csv");
        if(!outFile1.exists()) {
            outFile1.createNewFile();
        }
        sa_calculation(perform_time,sheet_num1, performer_percentage,sheet_num2, outFile1,outFile2,outFile3);
    }
